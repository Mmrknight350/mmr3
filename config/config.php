...
|
*/
$config['botToken'] = "5426799623:AAGJSTrxCKsi7CKubT4dKe1prTjcnkc2OQo";
...
|
*/
$config['db']['hostname'] =  "sql5.freesqldatabase.com";
$config['db']['username'] =  "sql5514577";
$config['db']['password'] =  "RVzURwXiUT";
$config['db']['database'] =  "sql5514577";
...
|
*/
$config['sk_keys'] =  array('sk_live_JasSPVsOiEe9nQsvWZQMz2eG');
?>
